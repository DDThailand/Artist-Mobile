...
class _CoinsViewState extends State<CoinsView>
  ...
  Future<void> _handlePaymentSuccess(PaymentSuccessResponse response) async {
    userCoins.value = userCoins.value + selectedCoins;
    Fluttertoast.showToast(
        msg: "SUCCESS: ${response.paymentId!}", timeInSecForIosWeb: 4);
    SuccessPurchasService().successPurchas(
        coinPlanId: coinsController.coinPlan.value, paymentGateway: "RAZORPAY");
  }
                                          ...
                                          onTap: () {
                                            ...
                                            Get.bottomSheet(
                                              purchaseSheet(
                                                ...
                                                coinsController.coinsPlanModel!
                                                    .coinPlan![index].coin!
                                                    .toInt(),
                                              ),
                                            );
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              gradient: LinearGradient(colors: [
                                                const Color(0xffE63792)
                                                    .withOpacity(0.5),
                                                const Color(0xff9A1CD7)
                                                    .withOpacity(0.5),
                                              ]),
                                              borderRadius:
                                                    ...
                                                    Container(
                                                      ...
                                                      padding:
                                                          const EdgeInsets.all(
                                                              8),
                                                      child: Text(
                                                          "+${coinsController.offer[index]} coins",
                                                          style: TextStyle(
                                                              color: ThemeColor
                                                                  .blackback,
                                                              fontWeight:
          ...
          return Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border:
                    Border.all(width: 1.2, color: Colors.grey.withOpacity(0.3)),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: (coinsController.paymentChoice1.value)
                            ...
                            : Border.all(
                                width: 1, color: const Color(0xFFE3E7EC)),
                      ...
                      child: Row(
                        children: [
                          SizedBox(
                            height: 60,
                            width: 60,
                            child: Image.asset("Images/Inapp.png",
                                fit: BoxFit.cover),
                          ),
                          const SizedBox(
                            width: 15,
                      ...
                      child: Row(
                        children: [
                          SizedBox(
                            height: 60,
                            width: 60,
                            child: Image.asset("Images/RazorPay.png",
                                fit: BoxFit.cover),
                          ),
                          const SizedBox(
                            width: 15,
                      ...
                      child: Row(
                        children: [
                          SizedBox(
                            height: 50,
                            width: 50,
                            child: Image.asset("Images/StripePay.png",
                                fit: BoxFit.cover),
                          ),
                          const SizedBox(
                            width: 25,
